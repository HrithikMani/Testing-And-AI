...
def verify_theme_changed(page: Page):
    """Verify the theme has changed (basic check)."""
    # The theme toggle changes data-theme attribute or a class
    # We just verify the toggle button is still present after click
    selector = get_selector('playwright_docs', 'theme_toggle')
