#! /usr/bin/env python
# MIE Test that a user with no patient-user relationship cannot access a restricted patient if he is not exempt
# Written by Aaron Lehmann
# Date: 02-04-2014 = initial creation

"""
user_access_restriction_pur.py -- Test that a user with no patient-user relationship cannot access a restricted patient if he is not exempt
"""
