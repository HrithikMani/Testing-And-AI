...
"""
Test details:
  Turn setting on (System/DB Routine/Sync user address with patient address not employer_address)
  Insert User
  Insert Patient
  Create Relation
...
def main(d, WCURL):
    ...
    patient = {
        ...
        'degree': 'Esquire',
        'suffix': 'Jr.',
        'address1': '456 Elsewhere Drive',
        'address2': 'P.O. Box 9482',
        'address3': 'Dog House',
        'city': 'Los Angeles',
        'state': 'CA',
        'zip_code': '09876',
    ...
    # Check that employer addresses are empty
    emp_fields = (
        ('employer_addr1', ['', ]),
        ('employer_addr2', ['', ]),
        ('employer_addr3', ['', ]),
